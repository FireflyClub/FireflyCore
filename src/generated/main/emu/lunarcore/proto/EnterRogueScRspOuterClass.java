...
public final class EnterRogueScRspOuterClass {
  /**
   * Protobuf type {@code EnterRogueScRsp}
   */
  public static final class EnterRogueScRsp extends ProtoMessage<EnterRogueScRsp> implements Cloneable {
    ...
    /**
     * <pre>
     *  PDBKKNJFBAJ FDAJEIDNMAK = 7;
     * </pre>
     *
     * <code>optional .RogueInfo rogue_info = 10;</code>
     */
    private final RogueInfoOuterClass.RogueInfo rogueInfo = RogueInfoOuterClass.RogueInfo.newInstance();

    private EnterRogueScRsp() {
    }

    /**
     * @return a new empty instance of {@code EnterRogueScRsp}
     */
    public static EnterRogueScRsp newInstance() {
      return new EnterRogueScRsp();
    }
     ...
     * @return this
     */
    public EnterRogueScRsp clearRetcode() {
     ...
     * @return this
     */
    public EnterRogueScRsp setRetcode(final int value) {
      bitField0_ |= 0x00000001;
      retcode = value;
      return this;
    }
     ...
     * @return this
     */
    public EnterRogueScRsp clearLineup() {
     ...
     * @return this
     */
    public EnterRogueScRsp setLineup(final LineupInfoOuterClass.LineupInfo value) {
      bitField0_ |= 0x00000002;
     ...
     * @return this
     */
    public EnterRogueScRsp clearScene() {
     ...
     * @return this
     */
    public EnterRogueScRsp setScene(final SceneInfoOuterClass.SceneInfo value) {
      bitField0_ |= 0x00000004;
     ...
     * @return this
     */
    public EnterRogueScRsp clearRogueInfo() {
     ...
     * @return this
     */
    public EnterRogueScRsp setRogueInfo(final RogueInfoOuterClass.RogueInfo value) {
      bitField0_ |= 0x00000008;
    ...
    @Override
    public EnterRogueScRsp copyFrom(final EnterRogueScRsp other) {
    ...
    @Override
    public EnterRogueScRsp mergeFrom(final EnterRogueScRsp other) {
      if (other.isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    @Override
    public EnterRogueScRsp clearQuick() {
      if (isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    public boolean equals(Object o) {
      ...
      if (!(o instanceof EnterRogueScRsp)) {
        return false;
      }
      EnterRogueScRsp other = (EnterRogueScRsp) o;
    ...
    public EnterRogueScRsp mergeFrom(final ProtoSource input) throws IOException {
    ...
    @Override
    public EnterRogueScRsp mergeFrom(final JsonSource input) throws IOException {
    ...
    public EnterRogueScRsp clone() {
      return new EnterRogueScRsp().copyFrom(this);
    }
    ...
    public static EnterRogueScRsp parseFrom(final byte[] data) throws
        InvalidProtocolBufferException {
      return ProtoMessage.mergeFrom(new EnterRogueScRsp(), data).checkInitialized();
    }

    public static EnterRogueScRsp parseFrom(final ProtoSource input) throws IOException {
      return ProtoMessage.mergeFrom(new EnterRogueScRsp(), input).checkInitialized();
    }

    public static EnterRogueScRsp parseFrom(final JsonSource input) throws IOException {
      return ProtoMessage.mergeFrom(new EnterRogueScRsp(), input).checkInitialized();
    }

    /**
     * @return factory for creating EnterRogueScRsp messages
     */
    public static MessageFactory<EnterRogueScRsp> getFactory() {
      return EnterRogueScRspFactory.INSTANCE;
    }

    private enum EnterRogueScRspFactory implements MessageFactory<EnterRogueScRsp> {
      INSTANCE;

      @Override
      public EnterRogueScRsp create() {
        return EnterRogueScRsp.newInstance();
      }
    }
