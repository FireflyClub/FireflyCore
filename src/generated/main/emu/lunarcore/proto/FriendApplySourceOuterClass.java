...
public final class FriendApplySourceOuterClass {
  ...
  public enum FriendApplySource implements ProtoEnum<FriendApplySource> {
    ...
    /**
     * <code>FRIEND_APPLY_SOURCE_ASSIST_REWARD = 6;</code>
     */
    FRIEND_APPLY_SOURCE_ASSIST_REWARD("FRIEND_APPLY_SOURCE_ASSIST_REWARD", 6);
     ...
     * <code>FRIEND_APPLY_SOURCE_ASSIST_REWARD = 6;</code>
     */
    public static final int FRIEND_APPLY_SOURCE_ASSIST_REWARD_VALUE = 6;
    ...
    enum FriendApplySourceConverter implements ProtoEnum.EnumConverter<FriendApplySource> {
      ...
      private static final FriendApplySource[] lookup = new FriendApplySource[7];
      ...
      static {
        ...
        lookup[6] = FRIEND_APPLY_SOURCE_ASSIST_REWARD;
      }
      ...
      public final FriendApplySource forName(final CharSequence value) {
        switch (value.length()) {
          ...
          case 33: {
            if (ProtoUtil.isEqual("FRIEND_APPLY_SOURCE_ASSIST_REWARD", value)) {
              return FRIEND_APPLY_SOURCE_ASSIST_REWARD;
            }
            break;
          }
          case 36: {
