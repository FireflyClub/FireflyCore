...
public final class GetHeroBasicTypeInfoScRspOuterClass {
  ...
  public static final class GetHeroBasicTypeInfoScRsp extends ProtoMessage<GetHeroBasicTypeInfoScRsp> implements Cloneable {
    ...
    /**
     * <code>optional .HeroBasicType cur_basic_type = 3;</code>
     */
    private int curBasicType;

    /**
     * <pre>
     * int32 cur_basic_type = 3;
     * </pre>
     *
     * <code>optional .Gender gender = 11;</code>
     */
    private int gender;

    /**
     * <code>optional bool ojfdpkajcbn = 5;</code>
     */
    private boolean ojfdpkajcbn;

    /**
     * <code>optional bool oncahldofel = 10;</code>
     */
    private boolean oncahldofel;
    ...
    /**
     * <code>optional bool ojfdpkajcbn = 5;</code>
     * @return whether the ojfdpkajcbn field is set
     */
    public boolean hasOjfdpkajcbn() {
     ...
     * @return this
     */
    public GetHeroBasicTypeInfoScRsp clearOjfdpkajcbn() {
    ...
    /**
     * <code>optional bool ojfdpkajcbn = 5;</code>
     * @return the ojfdpkajcbn
     */
    public boolean getOjfdpkajcbn() {
      return ojfdpkajcbn;
    }

    /**
     * <code>optional bool ojfdpkajcbn = 5;</code>
     * @param value the ojfdpkajcbn to set
     * @return this
     */
    public GetHeroBasicTypeInfoScRsp setOjfdpkajcbn(final boolean value) {
      bitField0_ |= 0x00000008;
      ojfdpkajcbn = value;
      return this;
    }
    ...
    /**
     * <code>optional bool oncahldofel = 10;</code>
     * @return whether the oncahldofel field is set
     */
    public boolean hasOncahldofel() {
     ...
     * @return this
     */
    public GetHeroBasicTypeInfoScRsp clearOncahldofel() {
    ...
    /**
     * <code>optional bool oncahldofel = 10;</code>
     * @return the oncahldofel
     */
    public boolean getOncahldofel() {
      return oncahldofel;
    }

    /**
     * <code>optional bool oncahldofel = 10;</code>
     * @param value the oncahldofel to set
     * @return this
     */
    public GetHeroBasicTypeInfoScRsp setOncahldofel(final boolean value) {
      bitField0_ |= 0x00000010;
      oncahldofel = value;
      return this;
    }
    ...
    public GetHeroBasicTypeInfoScRsp copyFrom(final GetHeroBasicTypeInfoScRsp other) {
      ...
      if ((bitField0_ | other.bitField0_) != 0) {
        ...
        gender = other.gender;
        ojfdpkajcbn = other.ojfdpkajcbn;
        oncahldofel = other.oncahldofel;
    ...
    public GetHeroBasicTypeInfoScRsp mergeFrom(final GetHeroBasicTypeInfoScRsp other) {
      ...
      if (other.hasOjfdpkajcbn()) {
        setOjfdpkajcbn(other.ojfdpkajcbn);
      }
      if (other.hasOncahldofel()) {
        setOncahldofel(other.oncahldofel);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasOjfdpkajcbn() || ojfdpkajcbn == other.ojfdpkajcbn)
        && (!hasOncahldofel() || oncahldofel == other.oncahldofel)
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000008) != 0) {
        ...
        output.writeBoolNoTag(ojfdpkajcbn);
      }
      if ((bitField0_ & 0x00000010) != 0) {
        output.writeRawByte((byte) 80);
        output.writeBoolNoTag(oncahldofel);
      }
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000008) != 0) {
        output.writeBool(FieldNames.ojfdpkajcbn, ojfdpkajcbn);
      }
      if ((bitField0_ & 0x00000010) != 0) {
        output.writeBool(FieldNames.oncahldofel, oncahldofel);
      }
      if ((bitField0_ & 0x00000020) != 0) {
    ...
    public GetHeroBasicTypeInfoScRsp mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case 1034233874: {
            if (input.isAtField(FieldNames.ojfdpkajcbn)) {
              if (!input.trySkipNullValue()) {
                ojfdpkajcbn = input.readBool();
                bitField0_ |= 0x00000008;
              }
          ...
          case 1963569025: {
            if (input.isAtField(FieldNames.oncahldofel)) {
              if (!input.trySkipNullValue()) {
                oncahldofel = input.readBool();
                bitField0_ |= 0x00000010;
              }
    ...
    static class FieldNames {
      ...
      static final FieldName ojfdpkajcbn = FieldName.forField("ojfdpkajcbn");

      static final FieldName oncahldofel = FieldName.forField("oncahldofel");
