...
public final class MissionDataOuterClass {
  ...
  public static final class MissionData extends ProtoMessage<MissionData> implements Cloneable {
     ...
     * @return this
     */
    public MissionData setId(final int value) {
      bitField0_ |= 0x00000001;
      id = value;
      return this;
    }
     ...
     * equivalent to {@link MissionData#getStatus()}.getNumber().
     *
     ...
     * can cause {@link MissionData#getStatus()} to return null
     *
     * @param value the numeric wire value to set
     * @return this
     */
    public MissionData setStatusValue(final int value) {
      bitField0_ |= 0x00000002;
      status = value;
      return this;
    }
     ...
     * @return this
     */
    public MissionData setStatus(final MissionStatusOuterClass.MissionStatus value) {
      bitField0_ |= 0x00000002;
     ...
     * @return this
     */
    public MissionData addCustomValueList(
     ...
     * @return this
     */
    public MissionData addAllCustomValueList(
    ...
    @Override
    public MissionData copyFrom(final MissionData other) {
    ...
    @Override
    public MissionData mergeFrom(final MissionData other) {
      if (other.isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    public boolean equals(Object o) {
      ...
      MissionData other = (MissionData) o;
    ...
    public MissionData mergeFrom(final ProtoSource input) throws IOException {
    ...
    @Override
    public MissionData mergeFrom(final JsonSource input) throws IOException {
    ...
    public MissionData clone() {
      return new MissionData().copyFrom(this);
    }
    ...
    public static MissionData parseFrom(final byte[] data) throws InvalidProtocolBufferException {
      return ProtoMessage.mergeFrom(new MissionData(), data).checkInitialized();
    }

    public static MissionData parseFrom(final ProtoSource input) throws IOException {
      return ProtoMessage.mergeFrom(new MissionData(), input).checkInitialized();
    }

    public static MissionData parseFrom(final JsonSource input) throws IOException {
      return ProtoMessage.mergeFrom(new MissionData(), input).checkInitialized();
    }

    /**
     * @return factory for creating MissionData messages
     */
    public static MessageFactory<MissionData> getFactory() {
      return MissionDataFactory.INSTANCE;
    }

    private enum MissionDataFactory implements MessageFactory<MissionData> {
      INSTANCE;

      @Override
      public MissionData create() {
        return MissionData.newInstance();
      }
    }
