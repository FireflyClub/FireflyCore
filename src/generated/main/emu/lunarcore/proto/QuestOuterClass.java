...
public final class QuestOuterClass {
  ...
  public static final class Quest extends ProtoMessage<Quest> implements Cloneable {
    ...
    /**
     * <code>repeated uint32 ANAKGMFIDBJ = 5;</code>
     */
    private final RepeatedInt aNAKGMFIDBJ = RepeatedInt.newEmptyInstance();
    ...
    /**
     * <code>repeated uint32 ANAKGMFIDBJ = 5;</code>
     * @return whether the aNAKGMFIDBJ field is set
     */
    public boolean hasANAKGMFIDBJ() {
     ...
     *
     * Use {@link #getMutableANAKGMFIDBJ()} if you want to modify it.
     *
     * @return internal storage object for reading
     */
    public RepeatedInt getANAKGMFIDBJ() {
      return aNAKGMFIDBJ;
    }
     ...
     */
    public RepeatedInt getMutableANAKGMFIDBJ() {
      bitField0_ |= 0x00000010;
      return aNAKGMFIDBJ;
    }
    ...
    /**
     * <code>repeated uint32 ANAKGMFIDBJ = 5;</code>
     * @param value the aNAKGMFIDBJ to add
     * @return this
     */
    public Quest addANAKGMFIDBJ(final int value) {
      bitField0_ |= 0x00000010;
      aNAKGMFIDBJ.add(value);
      return this;
    }

    /**
     * <code>repeated uint32 ANAKGMFIDBJ = 5;</code>
     * @param values the aNAKGMFIDBJ to add
     * @return this
     */
    public Quest addAllANAKGMFIDBJ(final int... values) {
      bitField0_ |= 0x00000010;
      aNAKGMFIDBJ.addAll(values);
      return this;
    }
    ...
    public Quest copyFrom(final Quest other) {
      ...
      if ((bitField0_ | other.bitField0_) != 0) {
        ...
        id = other.id;
        status = other.status;
        aNAKGMFIDBJ.copyFrom(other.aNAKGMFIDBJ);
      }
      return this;
    }
    ...
    public Quest mergeFrom(final Quest other) {
      ...
      if (other.hasANAKGMFIDBJ()) {
        getMutableANAKGMFIDBJ().addAll(other.aNAKGMFIDBJ);
      }
      return this;
    }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasANAKGMFIDBJ() || aNAKGMFIDBJ.equals(other.aNAKGMFIDBJ));
    }
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000010) != 0) {
        for (int i = 0; i < aNAKGMFIDBJ.length(); i++) {
          output.writeRawByte((byte) 40);
          output.writeUInt32NoTag(aNAKGMFIDBJ.array()[i]);
        }
      }
    }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000010) != 0) {
        size += (1 * aNAKGMFIDBJ.length()) + ProtoSink.computeRepeatedUInt32SizeNoTag(aNAKGMFIDBJ);
      }
      return size;
    }
    ...
    public Quest mergeFrom(final ProtoSource input) throws IOException {
      ...
      while (true) {
        switch (tag) {
          ...
          case 42: {
            // aNAKGMFIDBJ [packed=true]
            input.readPackedUInt32(aNAKGMFIDBJ, tag);
            bitField0_ |= 0x00000010;
            tag = input.readTag();
            if (tag != 0) {
              break;
          ...
          case 40: {
            // aNAKGMFIDBJ [packed=false]
            tag = input.readRepeatedUInt32(aNAKGMFIDBJ, tag);
            bitField0_ |= 0x00000010;
            break;
          }
        }
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000010) != 0) {
        output.writeRepeatedUInt32(FieldNames.aNAKGMFIDBJ, aNAKGMFIDBJ);
      }
      output.endObject();
    }
    ...
    public Quest mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case -2079954484: {
            if (input.isAtField(FieldNames.aNAKGMFIDBJ)) {
              if (!input.trySkipNullValue()) {
                input.readRepeatedUInt32(aNAKGMFIDBJ);
                bitField0_ |= 0x00000010;
              }
            } else {
              input.skipUnknownField();
    ...
    static class FieldNames {
      ...
      static final FieldName aNAKGMFIDBJ = FieldName.forField("ANAKGMFIDBJ");
    }
  }
}
