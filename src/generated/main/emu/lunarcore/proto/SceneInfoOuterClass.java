...
public final class SceneInfoOuterClass {
  ...
  public static final class SceneInfo extends ProtoMessage<SceneInfo> implements Cloneable {
    ...
    /**
     * <code>optional int32 leader_entity_id = 5;</code>
     */
    ...
    /**
     * <code>optional uint32 floor_id = 8;</code>
     */
    private int floorId;
    ...
    /**
     * <code>repeated uint32 lighten_section_list = 7;</code>
     */
     ...
     * </pre>
     *
     * <code>repeated uint32 group_id_list = 12;</code>
     */
    ...
    /**
     * <code>repeated .SceneGroupState group_state_list = 605;</code>
     */
     ...
     * </pre>
     *
     * <code>repeated .SceneEntityGroupInfo entity_group_list = 1132;</code>
     */
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      if ((bitField0_ & 0x00000001) != 0) {
        ...
        output.writeInt32NoTag(leaderEntityId);
      }
    ...
    protected int computeSerializedSize() {
      int size = 0;
      if ((bitField0_ & 0x00000001) != 0) {
        size += 1 + ProtoSink.computeInt32SizeNoTag(leaderEntityId);
      }
      if ((bitField0_ & 0x00000002) != 0) {
    ...
    public SceneInfo mergeFrom(final ProtoSource input) throws IOException {
      ...
      while (true) {
        switch (tag) {
          case 40: {
            // leaderEntityId
            leaderEntityId = input.readInt32();
            bitField0_ |= 0x00000001;
            tag = input.readTag();
            if (tag != 8) {
              break;
    ...
    public void writeTo(final JsonSink output) throws IOException {
      output.beginObject();
      if ((bitField0_ & 0x00000001) != 0) {
        output.writeInt32(FieldNames.leaderEntityId, leaderEntityId);
      }
      if ((bitField0_ & 0x00000002) != 0) {
