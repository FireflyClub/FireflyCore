...
public final class SearchPlayerScRspOuterClass {
  ...
  public static final class SearchPlayerScRsp extends ProtoMessage<SearchPlayerScRsp> implements Cloneable {
    ...
    /**
     * <code>repeated uint32 PEIFPGNGJGK = 1;</code>
     */
    private final RepeatedInt pEIFPGNGJGK = RepeatedInt.newEmptyInstance();

    /**
     * <code>repeated .SimpleInfo search_result_list = 12;</code>
     */
    ...
    /**
     * <code>repeated uint32 PEIFPGNGJGK = 1;</code>
     * @return whether the pEIFPGNGJGK field is set
     */
    public boolean hasPEIFPGNGJGK() {
     ...
     * @return this
     */
    public SearchPlayerScRsp clearPEIFPGNGJGK() {
     ...
     *
     * Use {@link #getMutablePEIFPGNGJGK()} if you want to modify it.
     *
     * @return internal storage object for reading
     */
    public RepeatedInt getPEIFPGNGJGK() {
      return pEIFPGNGJGK;
    }
     ...
     */
    public RepeatedInt getMutablePEIFPGNGJGK() {
      bitField0_ |= 0x00000002;
      return pEIFPGNGJGK;
    }
    ...
    /**
     * <code>repeated uint32 PEIFPGNGJGK = 1;</code>
     * @param value the pEIFPGNGJGK to add
     * @return this
     */
    public SearchPlayerScRsp addPEIFPGNGJGK(final int value) {
      bitField0_ |= 0x00000002;
      pEIFPGNGJGK.add(value);
      return this;
    }

    /**
     * <code>repeated uint32 PEIFPGNGJGK = 1;</code>
     * @param values the pEIFPGNGJGK to add
     * @return this
     */
    public SearchPlayerScRsp addAllPEIFPGNGJGK(final int... values) {
      bitField0_ |= 0x00000002;
      pEIFPGNGJGK.addAll(values);
      return this;
    }
    ...
    public SearchPlayerScRsp copyFrom(final SearchPlayerScRsp other) {
      ...
      if ((bitField0_ | other.bitField0_) != 0) {
        ...
        pEIFPGNGJGK.copyFrom(other.pEIFPGNGJGK);
    ...
    public SearchPlayerScRsp mergeFrom(final SearchPlayerScRsp other) {
      ...
      if (other.hasPEIFPGNGJGK()) {
        getMutablePEIFPGNGJGK().addAll(other.pEIFPGNGJGK);
      }
    ...
    public boolean equals(Object o) {
      ...
      return bitField0_ == other.bitField0_
        ...
        && (!hasPEIFPGNGJGK() || pEIFPGNGJGK.equals(other.pEIFPGNGJGK))
    ...
    public void writeTo(final ProtoSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        for (int i = 0; i < pEIFPGNGJGK.length(); i++) {
          output.writeRawByte((byte) 8);
          output.writeUInt32NoTag(pEIFPGNGJGK.array()[i]);
        }
      }
    ...
    protected int computeSerializedSize() {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        size += (1 * pEIFPGNGJGK.length()) + ProtoSink.computeRepeatedUInt32SizeNoTag(pEIFPGNGJGK);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public SearchPlayerScRsp mergeFrom(final ProtoSource input) throws IOException {
      ...
      while (true) {
        switch (tag) {
          ...
          case 10: {
            // pEIFPGNGJGK [packed=true]
            input.readPackedUInt32(pEIFPGNGJGK, tag);
            bitField0_ |= 0x00000002;
            tag = input.readTag();
            if (tag != 98) {
              break;
          ...
          case 8: {
            // pEIFPGNGJGK [packed=false]
            tag = input.readRepeatedUInt32(pEIFPGNGJGK, tag);
            bitField0_ |= 0x00000002;
            break;
          }
        }
    ...
    public void writeTo(final JsonSink output) throws IOException {
      ...
      if ((bitField0_ & 0x00000002) != 0) {
        output.writeRepeatedUInt32(FieldNames.pEIFPGNGJGK, pEIFPGNGJGK);
      }
      if ((bitField0_ & 0x00000004) != 0) {
    ...
    public SearchPlayerScRsp mergeFrom(final JsonSource input) throws IOException {
      ...
      while (!input.isAtEnd()) {
        switch (input.readFieldHash()) {
          ...
          case 333474988: {
            if (input.isAtField(FieldNames.pEIFPGNGJGK)) {
              if (!input.trySkipNullValue()) {
                input.readRepeatedUInt32(pEIFPGNGJGK);
                bitField0_ |= 0x00000002;
              }
            } else {
              input.skipUnknownField();
    ...
    static class FieldNames {
      ...
      static final FieldName pEIFPGNGJGK = FieldName.forField("PEIFPGNGJGK");
