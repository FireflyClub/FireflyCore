...
public final class StarFightDataOuterClass {
  /**
   * <pre>
   *  Nbchegjclei
   * </pre>
   *
   * Protobuf type {@code StarFightData}
   */
  public static final class StarFightData extends ProtoMessage<StarFightData> implements Cloneable {
     ...
     * </pre>
     *
     * @return a new empty instance of {@code StarFightData}
     */
    public static StarFightData newInstance() {
      return new StarFightData();
    }
     ...
     * @return this
     */
    public StarFightData clearGroupId() {
     ...
     * @return this
     */
    public StarFightData setGroupId(final int value) {
      bitField0_ |= 0x00000001;
      groupId = value;
      return this;
    }
     ...
     * @return this
     */
    public StarFightData clearHnegangajhp() {
     ...
     * @return this
     */
    public StarFightData setHnegangajhp(final int value) {
      bitField0_ |= 0x00000002;
      hnegangajhp = value;
      return this;
    }
     ...
     * @return this
     */
    public StarFightData clearLibllkckfbd() {
     ...
     * @return this
     */
    public StarFightData setLibllkckfbd(final int value) {
      bitField0_ |= 0x00000004;
      libllkckfbd = value;
      return this;
    }
     ...
     * @return this
     */
    public StarFightData clearFjncdcbcpfd() {
     ...
     * @return this
     */
    public StarFightData setFjncdcbcpfd(final int value) {
      bitField0_ |= 0x00000008;
      fjncdcbcpfd = value;
      return this;
    }
     ...
     * @return this
     */
    public StarFightData clearLmdkgeicefn() {
     ...
     * @return this
     */
    public StarFightData setLmdkgeicefn(final boolean value) {
      bitField0_ |= 0x00000010;
      lmdkgeicefn = value;
      return this;
    }
    ...
    @Override
    public StarFightData copyFrom(final StarFightData other) {
    ...
    @Override
    public StarFightData mergeFrom(final StarFightData other) {
      if (other.isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    @Override
    public StarFightData clearQuick() {
      if (isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    public boolean equals(Object o) {
      ...
      if (!(o instanceof StarFightData)) {
        return false;
      }
      StarFightData other = (StarFightData) o;
    ...
    public StarFightData mergeFrom(final ProtoSource input) throws IOException {
    ...
    @Override
    public StarFightData mergeFrom(final JsonSource input) throws IOException {
    ...
    @Override
    public StarFightData clone() {
      return new StarFightData().copyFrom(this);
    }
    ...
    public static StarFightData parseFrom(final byte[] data) throws InvalidProtocolBufferException {
      return ProtoMessage.mergeFrom(new StarFightData(), data).checkInitialized();
    }

    public static StarFightData parseFrom(final ProtoSource input) throws IOException {
      return ProtoMessage.mergeFrom(new StarFightData(), input).checkInitialized();
    }

    public static StarFightData parseFrom(final JsonSource input) throws IOException {
      return ProtoMessage.mergeFrom(new StarFightData(), input).checkInitialized();
    }

    /**
     * @return factory for creating StarFightData messages
     */
    public static MessageFactory<StarFightData> getFactory() {
      return StarFightDataFactory.INSTANCE;
    }

    private enum StarFightDataFactory implements MessageFactory<StarFightData> {
      INSTANCE;

      @Override
      public StarFightData create() {
        return StarFightData.newInstance();
      }
    }
