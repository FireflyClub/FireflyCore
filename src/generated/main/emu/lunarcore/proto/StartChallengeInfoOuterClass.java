...
public final class StartChallengeInfoOuterClass {
  /**
   * Protobuf type {@code StartChallengeInfo}
   */
  public static final class StartChallengeInfo extends ProtoMessage<StartChallengeInfo> implements Cloneable {
    private static final long serialVersionUID = 0L;

    /**
     * <code>optional .StartChallengeBossBuffInfo boss_info = 3;</code>
     */
    ...
    /**
     * <code>optional .StartChallengeStoryBuffInfo story_buff_info = 4;</code>
     */
    ...
    private StartChallengeInfo() {
    }

    /**
     * @return a new empty instance of {@code StartChallengeInfo}
     */
    public static StartChallengeInfo newInstance() {
      return new StartChallengeInfo();
    }
    ...
    public StartChallengeInfo clearChallengeInfoCase() {
     ...
     * @return this
     */
    public StartChallengeInfo clearBossInfo() {
     ...
     * @return this
     */
    public StartChallengeInfo setBossInfo(
     ...
     * @return this
     */
    public StartChallengeInfo clearStoryBuffInfo() {
     ...
     * @return this
     */
    public StartChallengeInfo setStoryBuffInfo(
    ...
    @Override
    public StartChallengeInfo copyFrom(final StartChallengeInfo other) {
    ...
    @Override
    public StartChallengeInfo mergeFrom(final StartChallengeInfo other) {
      if (other.isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    @Override
    public StartChallengeInfo clear() {
      if (isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    @Override
    public StartChallengeInfo clearQuick() {
      if (isEmpty()) {
        return this;
      }
      cachedSize = -1;
    ...
    public boolean equals(Object o) {
      ...
      if (!(o instanceof StartChallengeInfo)) {
        return false;
      }
      StartChallengeInfo other = (StartChallengeInfo) o;
    ...
    public StartChallengeInfo mergeFrom(final ProtoSource input) throws IOException {
    ...
    @Override
    public StartChallengeInfo mergeFrom(final JsonSource input) throws IOException {
    ...
    @Override
    public StartChallengeInfo clone() {
      return new StartChallengeInfo().copyFrom(this);
    }
    ...
    public static StartChallengeInfo parseFrom(final byte[] data) throws
        InvalidProtocolBufferException {
      return ProtoMessage.mergeFrom(new StartChallengeInfo(), data).checkInitialized();
    }

    public static StartChallengeInfo parseFrom(final ProtoSource input) throws IOException {
      return ProtoMessage.mergeFrom(new StartChallengeInfo(), input).checkInitialized();
    }

    public static StartChallengeInfo parseFrom(final JsonSource input) throws IOException {
      return ProtoMessage.mergeFrom(new StartChallengeInfo(), input).checkInitialized();
    }

    /**
     * @return factory for creating StartChallengeInfo messages
     */
    public static MessageFactory<StartChallengeInfo> getFactory() {
      return StartChallengeInfoFactory.INSTANCE;
    }

    private enum StartChallengeInfoFactory implements MessageFactory<StartChallengeInfo> {
      INSTANCE;

      @Override
      public StartChallengeInfo create() {
        return StartChallengeInfo.newInstance();
      }
    }
