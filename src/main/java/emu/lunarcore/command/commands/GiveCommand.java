    ...
    public void execute(CommandArgs args) {
        ...
        for (String arg : args.getList()) {
            ...
            if (itemData.getItemMainType() == ItemMainType.AvatarCard) {
                ...
                args.getOnlineTarget().addAvatar(avatar);
            } else if (itemData.isEquippable()) {
                // Make sure we dont go over the inventory limit
                var tab = args.getOnlineTarget().getInventory().getTabByItemType(itemData.getItemMainType());
            ...
            // Send message
            args.sendMessage("Giving " + args.getOnlineTarget().getName() + " " + amount + " of " + itemId);
        }
