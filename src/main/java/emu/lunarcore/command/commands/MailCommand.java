...
@Command(label = "mail", aliases = {"m"}, permission = {"vip"}, requireTargetOnline = true, desc = "/mail [content]. Sends the targeted player a system mail.")
public class MailCommand implements CommandHandler {
    ...
    public void execute(CommandArgs args) {
        ...
        // Send to target
        args.getOnlineTarget().getMailbox().sendMail(mail);
        
        args.sendMessage("Sending mail to " + args.getOnlineTarget().getName());
    }
