...
@Command(label = "register", aliases = {"reg"}, permission = {"admin"}, requireTarget = true, desc = "/register [account]. Register a new account.")
public class RegisterCommand implements CommandHandler {
    ...
    public void execute(CommandArgs args) {
        ...
        ConfigManager.getLoginData().update(account, pwd);
