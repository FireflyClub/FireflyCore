    ...
    public PacketChallengeBossPhaseSettleNotify(ChallengeInstance challenge) {
        ...
        var data = ChallengeBossPhaseSettleNotify
            .newInstance()
                ...
                .setOFECNECFJJI(challenge.getCurrentStage() == 2) // show completion reward
                .setEEPIGCKDPDK(true) // if false, the AV battle target not shown
                .setOGMPDLCDJDL(1); // if the value is not 1, will show stars
